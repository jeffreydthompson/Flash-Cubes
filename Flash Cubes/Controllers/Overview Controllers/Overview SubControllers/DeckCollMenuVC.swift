...
class DeckCollMenuVC: UIViewController {

    var delegate: DeckCollMenuDelegate!
    ...
    let functions: [String : (sortBy: DeckCollection.SortBy, order: DeckCollection.SortOrder)] = [
        AppText.sortNameAsc : (sortBy: .deckName, order: .ascending),
        AppText.sortNameDesc : (sortBy: .deckName, order: .descending),
        AppText.sortDueAsc : (sortBy: .nextReviewDate, order: .ascending),
        AppText.sortDueDesc : (sortBy: .nextReviewDate, order: .descending),
        AppText.sortRetAsc : (sortBy: .deckRetention, order: .ascending),
        AppText.sortRetDesc : (sortBy: .deckRetention, order: .descending),
        AppText.sortProfAsc : (sortBy: .deckProficiency, order: .ascending),
        AppText.sortProfDesc : (sortBy: .deckProficiency, order: .descending)
    ]
...
extension DeckCollMenuVC: UIPickerViewDataSource {
...
extension DeckCollMenuVC: UIPickerViewDelegate {
